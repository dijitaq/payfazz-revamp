...
( function () {
	...
	var controller = new (scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_0___default().Controller)( { globalSceneOptions: { duration: duration } } );

	new (scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_0___default().Scene)( { triggerElement: '#hero-image' } )
		.setClassToggle( '#trigger-hero-image', 'product-navigation__list-item--active' )
		//.addIndicators()
		.addTo( controller );

	new (scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_0___default().Scene)( { triggerElement: '#payment' } )
		.setClassToggle( '#trigger-payment', 'product-navigation__list-item--active' )
		//.addIndicators()
		.addTo( controller );

	new (scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_0___default().Scene)( { triggerElement: '#capital' } )
		.setClassToggle( '#trigger-capital', 'product-navigation__list-item--active' )
		//.addIndicators()
		.addTo( controller );

	new (scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_0___default().Scene)( { triggerElement: '#cash' } )
		.setClassToggle( '#trigger-cash', 'product-navigation__list-item--active' )
		//.addIndicators()
		.addTo( controller );

	new (scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_0___default().Scene)( { triggerElement: '#loyalty' } )
